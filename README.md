...
[![Stars](https://img.shields.io/github/stars/Phoenix-Execute-Update-v3.4?style=flat-square)](https://github.com)
...
git clone https://github.com/Phoenix-Execute-Update-v3.4.git
cd Phoenix-Execute-Update-v3.4
